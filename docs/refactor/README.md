...
| ④ | **입장 거절 품질** | 매달림 0 하드 보장은 ①②가 이미 delivered — ④는 거절 품질만 더한다: 503에 Retry-After(재시도 폭풍 방지) + `orders_admission_rejected_total{stage}` 셰딩 메트릭(⑤ 관측). 게이트 통합·히스테리시스는 의도적 제외(측정 기반 후속) | 🔨 설계 완료 ([스펙](../superpowers/specs/2026-07-21-admission-reject-quality-design.md)) | — |

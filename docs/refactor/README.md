...
| ③ | **취소 우선 경로** | 엔진 루프의 동등 select를 priority select로 — 취소를 신규 주문보다 먼저 드레인해 리스크 관리 행동이 굶지 않도록(P1 해소; P2 엔진 정지는 ①②④). 백로그 "CancelCh 용량/취소 우선순위" 승격 | 🔨 설계 완료 ([스펙](../superpowers/specs/2026-07-20-cancel-priority-scheduling-design.md)) | — |

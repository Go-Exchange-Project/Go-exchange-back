...
func OpenIntegrationDB(t testing.TB) *gorm.DB {
	...
	// 통합 테스트와 운영 스키마가 갈린다.
	fatalIfErr(t, db.AutoMigrate(&model.User{}, &model.Order{}, &model.Trade{}, &model.FailedSettlement{}, &model.FailedMarketCompletion{}, &model.FailedOrderCancellation{}, &model.ReconciliationViolation{}, &model.TradeOutboxEvent{},
